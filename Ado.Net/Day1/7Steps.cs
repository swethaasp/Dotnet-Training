...
namespace AdoNetDemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //cmd.CommandText = "Insert into Emp1(EmpName, EmpSalary) values('" + "Dinesh" + "'," + "34534);";
            //cmd.CommandType = CommandType.Text;


            // Corrected command for inserting, without specifying EmpID
            cmd.CommandText = "Insert into Emp1(EmpName, EmpSalary) values('Anadhi', 40380);";
            cmd.CommandType = CommandType.Text;
